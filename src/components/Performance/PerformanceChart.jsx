...
import {Chart as ChartJS, BarElement, CategoryScale, LinearScale, ChartArea} from "chart.js";
...
import PerformChartTest from "./PerformChartTest";
...
const PerformChart = () => {
    ...
    useEffect(() => {
        dispatch(getDepartment(name, prevYear, curYear))
