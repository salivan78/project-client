...
const DataChartAddFormTest = ({prevYearData, currentYearData}) => {
    const dispatch = useDispatch()
    const prevData = useSelector(state => state.dataChartTest.prevData)
    const curData = useSelector(state => state.dataChartTest.curData)
    //const chartId = useSelector(state => state.dataChart.curData._id)
    const year = useSelector(state => state.dataChartTest.curData.year)
    ...
    const comment = useSelector(state => state.dataChartTest.comment)
    const [edit, setEdit] = useState(false)
    //const role = useSelector(state => state.user.userRole)

    // useEffect(() => {
    //     dispatch(getCurrentComment(year, 'Jan'))
    // }, [])
    ...
    function commentDisplay(e) {
        ...
        // if (month !== 'title') {
        //     dispatch(getCurrentComment(year, month))
        // }
    }
...
export default DataChartAddFormTest;